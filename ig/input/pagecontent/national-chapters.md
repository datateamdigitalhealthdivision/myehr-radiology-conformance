...
The formal narrative chapters of the Malaysian radiology conformance repository remain part of the same publication set as this FHIR guide. They provide governance, scope, actor, security, testing, and procurement context that the computable artefacts alone do not replace.
...
- Workflow chapters and technical annexes are published separately because they span FHIR, DICOM, DICOMweb, IHE, XDS-I, and transition material.
